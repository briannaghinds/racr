...
"""
from helpers import data_cleaning, build_baseline_lap_times, load_telemetry_profiles, load_track_encoding, plot_circuit_animated, race_explain_visualizer, _lookup_profile
...
def build_ui_structure():
    ...
    col_strategy, col_track_vis, col_telem = st.columns([1, 2, 2])
